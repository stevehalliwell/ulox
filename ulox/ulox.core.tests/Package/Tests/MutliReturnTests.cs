...
print (res1);");
            ...
            Assert.AreEqual("Multi var assign to result mismatch. Taking '1' but results contains '2' at ip:'10' in chunk:'unnamed_chunk'.", testEngine.InterpreterResult);
        }
...
print (res3);");
            ...
            Assert.AreEqual("Multi var assign to result mismatch. Taking '3' but results contains '2' at ip:'10' in chunk:'unnamed_chunk'.", testEngine.InterpreterResult);
        }
...
print(res2);");
            ...
            Assert.AreEqual("Multi var assign to result mismatch. Taking '2' but results contains '1' at ip:'10' in chunk:'unnamed_chunk'.", testEngine.InterpreterResult);
        }
