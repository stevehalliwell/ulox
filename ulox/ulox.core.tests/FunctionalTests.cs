...
");
            ...
            StringAssert.StartsWith("Pure call 'Foo' with non-pure confirming argument '<closure Meth upvals:0>' at ip:'28' in chunk:'unnamed_chunk(test:12)'.", testEngine.InterpreterResult);
        }
