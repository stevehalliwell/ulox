...
print (A(10)+B()*C());");
        ...
        //todo we to be abel to do ProcessSingleUsageLabels but it's not playing nice
//        [Test]
...
//            StringAssert.Contains("Instructions: 19 -> 3", _opt.OptimisationReporter.GetReport().GenerateStringReport());
//        }
...
//            StringAssert.Contains("Instructions: 66 -> 44", _opt.OptimisationReporter.GetReport().GenerateStringReport());
//        }
...
//            StringAssert.Contains("Instructions: 59 -> 4", _opt.OptimisationReporter.GetReport().GenerateStringReport());
//        }
...
//            StringAssert.Contains("Instructions: 27 -> 10", _opt.OptimisationReporter.GetReport().GenerateStringReport());
//            StringAssert.Contains("Labels: 6 -> 1", _opt.OptimisationReporter.GetReport().GenerateStringReport());
//        }
...
//            StringAssert.Contains("Instructions: 15 -> 3", _opt.OptimisationReporter.GetReport().GenerateStringReport());
//        }
...
//            StringAssert.Contains("Instructions: 784 -> ", _opt.OptimisationReporter.GetReport().GenerateStringReport());
//        }
    }
}
