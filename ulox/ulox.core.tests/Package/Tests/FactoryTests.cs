...
");
            ...
            StringAssert.StartsWith("Factory contains no line of key '1' at ip:'1' in chunk:'Line'.", testEngine.InterpreterResult);
        }
...
");
            ...
            StringAssert.StartsWith("'SetLine' must have non null key argument at ip:'1' in chunk:'SetLine'.", testEngine.InterpreterResult);
        }
...
");
            ...
            StringAssert.StartsWith("'SetLine' must have non null line argument at ip:'1' in chunk:'SetLine'.", testEngine.InterpreterResult);
        }
