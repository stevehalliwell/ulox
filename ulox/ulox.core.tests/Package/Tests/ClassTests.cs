...
class A 
{
    init(){return 7;}
            ...
            Assert.AreEqual("Cannot return an expression from an 'init' in chunk 'init(test)' at 4:21 'return'.", testEngine.InterpreterResult);
        }
...
var a = this.a;");
            ...
            Assert.AreEqual("Cannot use the 'this' keyword outside of a class in chunk 'unnamed_chunk(test)' at 2:15 'this'.", testEngine.InterpreterResult);
        }
...
var t = T();");
            ...
            Assert.AreEqual("Stage out of order. Type 'T' is at stage 'Method' has encountered a late 'Init' stage element in chunk 'unnamed_chunk(test)' at 5:12 'init'.", testEngine.InterpreterResult);
        }
...
print(t.b);");
            ...
            Assert.AreEqual("Stage out of order. Type 'T' is at stage 'Init' has encountered a late 'Var' stage element in chunk 'unnamed_chunk(test)' at 5:11 'var'.", testEngine.InterpreterResult);
        }
